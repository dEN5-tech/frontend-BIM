...
const theme = extendTheme({
  colors: {
    brand: {
      lavender: "#F2F2F2", // Used for highlighting key interface elements and calls to action
      black: "#000000", // Used for primary text and critical elements
      skyBlue: "#9F6AA6", // Used for background elements to promote a calm and productive environment
      mintGreen: "#9F6AA6", // Used for success states and progress indicators
